...
<template>
  ...
  <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div>
        <img class="mx-auto h-16 w-auto" src="../assets/e-book.png" alt="LIBRIS" />
        <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Entrar na LIBRIS</h2>
        <p class="mt-2 text-center text-sm text-gray-600">
          <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500"> Gerenciamento de Biblioteca Particulas </a>
        </p>
      </div>
